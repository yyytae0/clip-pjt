  ...
  return (
    <div>
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex">
          <div className="col-2 max-w-sm border-solid rounded border-2">
            <Droppable droppableId="droppable">
              {(provided) => (
                <ClipFrame ref={provided.innerRef} {...provided.droppableProps} />
              )}
            </Droppable>
          </div>
          <div className="col-2 max-w-sm p-2 border-solid rounded border-2">
            <Droppable droppableId="droppable">
              {(provided) => (
